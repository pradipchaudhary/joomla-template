...
class plgContentAdmirorGallery extends JPlugin {
    ...
    function onContentPrepare($context, &$row, &$params, $limitstart = 0) {
        ...
        if (preg_match_all("#{AdmirorGallery[^}]*}(.*?){/AdmirorGallery}|{AG[^}]*}(.*?){/AG}#s", $row->text, $matches, PREG_PATTERN_ORDER) > 0) {
            ...
            $row->text .= '<br /><a href="http://www.admiror-design-studio.com" target="_blank">AdmirorGallery ' . AG_VERSION . '</a>, ' . JText::_("AG_AUTHORS") . ' <a href="http://www.vasiljevski.com/" target="_blank">Vasiljevski</a> & <a href="http://www.admiror-design-studio.com" target="_blank">Kekeljevic</a>.<br /> <a href="https://www.security-audit.com/wordpress-security-audit/" target="_blank">website security audit provided by Security Audit Systems</a> a website security company</div>';
